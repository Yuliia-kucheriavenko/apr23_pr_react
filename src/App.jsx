...
export const App = () => {
  ...
  const products = productsFromServer.map((product) => {
    const category = categories
      .find(categoryObj => categoryObj.id === product.categoryId);
    const user = users.find(userObj => userObj.id === category.ownerId);
  ...
  const filteredProducts = products.filter((product) => {
    ...
    return product
      .name.toLowerCase()
      .includes(searchValue.toLowerCase()) && product.user === selectedUser;
  });
